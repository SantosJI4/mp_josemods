...
// array
DO_API(const Il2CppClass*, il2cpp_array_class_get, (const Il2CppClass * element_class, uint32_t rank));
DO_API(uint32_t, il2cpp_array_length, (Il2CppArray * array));
DO_API(uint32_t, il2cpp_array_get_byte_length, (Il2CppArray * array));
DO_API(Il2CppArray*, il2cpp_array_new, (const Il2CppClass * elementTypeInfo, il2cpp_array_size_t length));
DO_API(Il2CppArray*, il2cpp_array_new_specific, (const Il2CppClass * arrayTypeInfo, il2cpp_array_size_t length));
DO_API(Il2CppArray*, il2cpp_array_new_full, (const Il2CppClass * array_class, il2cpp_array_size_t * lengths, il2cpp_array_size_t * lower_bounds));
DO_API(const Il2CppClass*, il2cpp_bounded_array_class_get, (const Il2CppClass * element_class, uint32_t rank, bool bounded));
DO_API(int, il2cpp_array_element_size, (const Il2CppClass * array_class));

// assembly
DO_API(const Il2CppImage*, il2cpp_assembly_get_image, (const Il2CppAssembly * assembly));
DO_API(const Il2CppImage*, il2cpp_assembly_get_next, (const Il2CppAssembly * assembly));

// class
DO_API(void, il2cpp_class_for_each, (void(*klassReportFunc)(const Il2CppClass* klass, void* userData), void* userData));
DO_API(const Il2CppType*, il2cpp_class_enum_basetype, (const Il2CppClass * klass));
DO_API(bool, il2cpp_class_is_generic, (const Il2CppClass * klass));
DO_API(bool, il2cpp_class_is_inflated, (const Il2CppClass * klass));
DO_API(bool, il2cpp_class_is_assignable_from, (const Il2CppClass * klass, const Il2CppClass * oklass));
DO_API(bool, il2cpp_class_is_subclass_of, (const Il2CppClass * klass, const Il2CppClass * klassc, bool check_interfaces));
DO_API(bool, il2cpp_class_has_parent, (const Il2CppClass * klass, const Il2CppClass * klassc));
DO_API(const Il2CppClass*, il2cpp_class_from_il2cpp_type, (const Il2CppType * type));
DO_API(const Il2CppClass*, il2cpp_class_from_name, (const Il2CppImage * image, const char* namespaze, const char *name));
DO_API(const Il2CppClass*, il2cpp_class_from_system_type, (Il2CppReflectionType * type));
DO_API(const Il2CppClass*, il2cpp_class_get_element_class, (const Il2CppClass * klass));
...
DO_API(const Il2CppClass*, il2cpp_class_get_nested_types, (const Il2CppClass * klass, void* *iter));
DO_API(const Il2CppClass*, il2cpp_class_get_interfaces, (const Il2CppClass * klass, void* *iter));
...
DO_API(int32_t, il2cpp_class_instance_size, (const Il2CppClass * klass));
...
DO_API(int32_t, il2cpp_class_value_size, (const Il2CppClass * klass, uint32_t * align));
...
DO_API(const Il2CppClass*, il2cpp_class_from_type, (const Il2CppType * type));
DO_API(const Il2CppType*, il2cpp_class_get_type, (const Il2CppClass * klass));
DO_API(uint32_t, il2cpp_class_get_type_token, (const Il2CppClass * klass));
DO_API(bool, il2cpp_class_has_attribute, (const Il2CppClass * klass, const Il2CppClass * attr_class));
DO_API(bool, il2cpp_class_has_references, (const Il2CppClass * klass));
DO_API(bool, il2cpp_class_is_enum, (const Il2CppClass * klass));
DO_API(const Il2CppImage*, il2cpp_class_get_image, (const Il2CppClass * klass));
...
DO_API(void, il2cpp_class_get_bitmap, (const Il2CppClass * klass, size_t * bitmap));
...
DO_API(Il2CppDomain*, il2cpp_domain_get_next, (Il2CppDomain*));
...
DO_API(Il2CppException*, il2cpp_exception_from_name, (const char *name_space, const char *name));
...
DO_API(Il2CppStackTrace*, il2cpp_exception_getTrace, (const Il2CppException * ex, int addresses));
DO_API(int32_t, il2cpp_stack_trace_get_frame_count, (Il2CppStackTrace* ex));
DO_API(void, il2cpp_stack_trace_get_frame, (Il2CppStackTrace*, int, Il2CppStackFrameInfo*));

// field
DO_API(int, il2cpp_field_get_flags, (FieldInfo * field));
DO_API(const char*, il2cpp_field_get_name, (FieldInfo * field));
DO_API(const Il2CppClass*, il2cpp_field_get_parent, (FieldInfo * field));
...
DO_API(bool, il2cpp_field_has_attribute, (FieldInfo * field, const Il2CppClass * attr_class));
...
// liveness
DO_API(void*, il2cpp_unity_liveness_allocate_struct, (const Il2CppClass * filter, int max_object_count, il2cpp_register_object_callback callback, void* userdata, il2cpp_liveness_reallocate_callback reallocate));
...
DO_API(const Il2CppClass*, il2cpp_method_get_declaring_type, (const MethodInfo * method));
...
DO_API(Il2CppReflectionMethod*, il2cpp_method_get_object, (const MethodInfo * method, const Il2CppClass * refclass));
...
DO_API(const Il2CppClass*, il2cpp_method_get_class, (const MethodInfo * method));
DO_API(bool, il2cpp_method_has_attribute, (const MethodInfo * method, const Il2CppClass * attr_class));
...
DO_API(const Il2CppClass*, il2cpp_property_get_parent, (PropertyInfo * prop));

// object
DO_API(const Il2CppClass*, il2cpp_object_get_class, (Il2CppObject * obj));
...
DO_API(Il2CppObject*, il2cpp_value_box, (const Il2CppClass * klass, void* data));
...
DO_API(void, il2cpp_runtime_class_init, (const Il2CppClass * klass));
...
// string
DO_API(int32_t, il2cpp_string_length, (MonoString * str));
DO_API(Il2CppChar*, il2cpp_string_chars, (MonoString * str));
DO_API(MonoString*, il2cpp_string_new, (const char* str));
DO_API(MonoString*, il2cpp_string_new_len, (const char* str, uint32_t length));
DO_API(MonoString*, il2cpp_string_new_utf16, (const Il2CppChar * text, int32_t len));
DO_API(MonoString*, il2cpp_string_new_wrapper, (const char* str));
DO_API(MonoString*, il2cpp_string_intern, (MonoString * str));
DO_API(MonoString*, il2cpp_string_is_interned, (MonoString * str));
...
DO_API(const Il2CppClass*, il2cpp_type_get_class_or_element_class, (const Il2CppType * type));
...
// custom attributes
DO_API(Il2CppCustomAttrInfo*, il2cpp_custom_attrs_from_class, (const Il2CppClass * klass));
DO_API(Il2CppCustomAttrInfo*, il2cpp_custom_attrs_from_method, (const MethodInfo * method));

DO_API(Il2CppObject*, il2cpp_custom_attrs_get_attr, (Il2CppCustomAttrInfo * ainfo, const Il2CppClass * attr_klass));
DO_API(bool, il2cpp_custom_attrs_has_attr, (Il2CppCustomAttrInfo * ainfo, const Il2CppClass * attr_klass));
...
DO_API(void, il2cpp_class_set_userdata, (const Il2CppClass * klass, void* userdata));
